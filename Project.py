...
diamonds_df = spark.sql("SELECT carat, cut, color, clarity, depth, x, y, z, price FROM diamonds")
...
#     inputCols=["carat","cut","color","clarity","depth","table","x","y","z"],
#     outputCol="features",
...
#     connection.open()
#     table = connection.table('diamondmetrics')  # Update table name
